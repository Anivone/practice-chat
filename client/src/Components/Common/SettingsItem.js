    ...
    return (
        <Box display="flex" height="100%" flexDirection="column" justifyContent="center">
            ...
            <Box display="flex" width="100%" height="95%" flexDirection="column" justifyContent="space-around">
                ...
                <Box display="flex" flexDirection="column" width="100%" height="65%" justifyContent="space-around">
                    <Typography variant="body1" style={{paddingLeft: 10}}>Edit profile</Typography>
                    <form action="" method="post">
                        <Box height="300px" width="90%" display="flex" justifyContent="space-around"
                            ...
                            <Button variant="contained" color="primary" type="submit" style={{width: 150, marginTop:15,borderRadius:30}}>
                                Save
                            </Button>
                        </Box>
                    </form>
