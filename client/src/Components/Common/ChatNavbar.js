...
function ChatNavbar ({name, iconColor, setChat}){
    ...
    return (
        <Box width="100%"  bgcolor="#e8eaf6" height="100%" display="flex" paddingLeft={3}>
            <Box width="90%" display="flex">
                <Box height="80%"  display="flex" justifyContent="space-between" alignItems="center" alignSelf="center">
                    ...
                    />
                    <Typography className={classes.txt} variant="body1">{name}</Typography>
                </Box>
            </Box>
            <Box width="10%" height="80%" display="flex" alignItems="center" alignSelf="center">
                <IconButton><HighlightOffIcon fontSize="large" onClick={handleCloseChat}/></IconButton>
            </Box>
            {/*<Modal*/}
